...
CREATE TABLE siblings AS
  SELECT a.child as first, b.child second
...
SELECT name AS dogs, height AS stack_height, height AS last_height, 1 AS n
FROM dogs;

INSERT INTO stacks_helper(dogs, stack_height, last_height, n)
SELECT dogs || ", " || name, stack_height+ height, height, n+1
